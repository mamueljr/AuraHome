    ...
    >
      <Card>
        <CardContent className="flex items-center gap-3">
          ...
          >
            {isImage ? (
              <img src={doc.fileData} alt="" className="size-full object-cover" />
            ) : (
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 items-center justify-center overflow-auto">
        {isImage ? (
          <img src={doc.fileData} alt={doc.title} className="max-h-full max-w-full rounded-lg" />
        ) : isPdf ? (
          <iframe src={doc.fileData} title={doc.title} className="size-full rounded-lg bg-white" />
        ) : (
